...
https://docs.netapp.com/us-en/bluexp-backup-recovery/concept-backup-to-cloud.html["Lesen Sie, wie Sie mit dem Cloud Backup Service ONTAP Daten sichern und wiederherstellen"^].
